...
| 항목 | 구성·단위 | 가격 (원) |
|---|---|---|
| 채소 | 상추·고추·마늘·양파 (30~40명 기준) | 40,000 |
| 김치 | — | 40,000 |
| 식사 | 콩나물 김칫국·오뎅탕, 반찬 3종 | 6,000 |
| 육개장 · 동태탕 | 밥·찬 별도 | 8,000 |
| 모듬전·홍어무침·잡채·골뱅이(오징어)무침·과일 | 30~40명 기준 | 120,000 |
...
- 모듬전·홍어무침·잡채·골뱅이(오징어)무침·과일은 단품이 아닌 30~40명 기준 통합 패키지 한 줄로만 노출한다 (1Kg 단품 행은 두지 않음).
