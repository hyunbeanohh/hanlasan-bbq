    ...
    <section className="py-20 md:py-24 bg-cream">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="relative aspect-[3/4] max-w-sm mx-auto lg:mx-0 w-full rounded-2xl overflow-hidden bg-gradient-to-br from-warm-200 via-warm-100 to-warm-50 flex flex-col items-center justify-center gap-4">
            <span className="text-7xl" aria-hidden="true">👨‍🍳</span>
            <p className="text-muted text-sm font-medium">셰프 사진 준비중</p>
          </div>
